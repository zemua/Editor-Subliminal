...
public class WavFile
{
	...
	public void display(PrintStream out)
	{
        ...
        // Función modificada por mi para crear un Array de WavFiles
        public static WavFile openArrayWavFile(File file, WavFile archivoWav) throws IOException, WavFileException
	{
		// Instantiate new Wavfile and store the file reference
		//WavFile wavFile = new WavFile();
                WavFile wavFile = archivoWav;
		wavFile.file = file;
